  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto section-padding py-24 sm:py-32 lg:py-40 text-center">
        ...
        <h1 className="font-heading text-[1.75rem] sm:text-5xl lg:text-7xl font-bold tracking-[0.005em] sm:tracking-wide uppercase text-primary-foreground mb-5 leading-tight whitespace-pre-line">
          {settings.hero_heading}
        </h1>
        <p className="text-[0.85rem] sm:text-lg text-primary-foreground/60 mb-10 max-w-xl mx-auto tracking-[0.005em] sm:tracking-wide">
